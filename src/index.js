...
function generatePdf(data, callback) {
  ...
  try {
    ...
    if (curso === 11 || curso === 12 || curso === 13 || curso === 14 || curso === 61) {
      ...
      pdfDefinition = {
        ...
        content: [
          ...
          },
          {
            ...
            fontSize: 16,
            alignment: 'left',
            absolutePosition: { x: 493, y: 395 }, // Posición debajo del nombre
          },
        ],
      };
    } else if (curso === 12) {
      ...
      pdfDefinition = {
        ...
        content: [
          ...
          },
          {
            ...
            absolutePosition: { x: 538, y: 384 }, // Posición debajo del nombre
          },
        ],
      };  
    } else {
